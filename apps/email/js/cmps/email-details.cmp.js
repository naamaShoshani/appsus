...
export default {
    ...
    <section class="email-details">
        ...
        <div class="email-details-subtitle">
            <h3>from: {{email.from}} <span class="email-details-date">{{dateToShow}}</span></h3>\
            <br><h5>to: {{email.to}}</h5>
            <div class="tools">
	...
	computed: {
		dateToShow() {
			return (
				this.email.sentAt.strDate +
				", " +
				this.email.sentAt.hours +
				":" +
				this.email.sentAt.minutes
			);
		},
	},
